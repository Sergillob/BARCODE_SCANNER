sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("sl.barcode.controller.BarcodeScanner", {
            onInit: function () {

            },
            //blog: https://blogs.sap.com/2021/09/02/providing-native-barcode-scanning-on-sap-mobile-start-sapui5-quagga.js/
            ...
            _initQuagga: function (oTarget) {
                ...
                Quagga.init({
                    ...
                    decoder: {
                        readers: [{
                            format: "code_128_reader", //Podem afegir més formats, mirar docu de Quagga.js 
                            config: {}
                        }]
                    },
                    locate: true
